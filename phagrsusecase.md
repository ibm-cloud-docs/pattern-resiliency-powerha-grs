...
Local high availability and backup architectures for IBM i on Power Virtual Server are documented in separate patterns and are not covered in this document.
{: note}
